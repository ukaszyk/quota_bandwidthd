...
# LAST MODIFIED:  2015-07-01 11:53:39
#      REVISION:  ---
#===============================================================================
...
rm /etc/config/bandwidthd
touch /etc/config/bandwidthd
sync

uci add bandwidthd bandwidthd
...
uci set bandwidthd.@quota[-1].limit_mb='100'
